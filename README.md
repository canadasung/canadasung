...
- **[Species name search](https://github.com/canadasung/species-search)** -- FastAPI backend with async fan-out across 15+ biodiversity APIs, Redis caching, and a Next.js frontend. Sub-2s response across all sources.
- **[SQL query optimization study](https://github.com/canadasung/sql-benchmarks)** -- Benchmarking CTE, window function, and aggregation patterns across PostgreSQL and BigQuery on 10M-row datasets.

More on my [portfolio site](https://canadasung.github.io).
